...
static const char __pyx_k_author_Harold_file_hello_world[] = "\n@author:Harold\n@file: hello_world.py\n@time: 30/05/2019\n";
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "hello_world",
    __pyx_k_author_Harold_file_hello_world, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("hello_world", __pyx_methods, __pyx_k_author_Harold_file_hello_world, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
